        ...
        <div className={styles.contCards}>
          ...
          <div className={styles.cardClase}>
            ...
            <div className={styles.cardContent}>
              ...
              <p className={styles.description}>
                Diviértete y combina el baile con una rutina de ejercicio al
                ritmo de la música, mejora tu condición y coordinación.
              </p>
            </div>
          </div>
          ...
          <div className={styles.cardClase}>
            ...
            <div className={styles.cardContent}>
              ...
              <p className={styles.description}>
                Libera tu energía en un entrenamiento guiado que combina
                técnicas de artes marciales, música y ejercicio cardiovascular.
              </p>
            </div>
          </div>
        </div>
