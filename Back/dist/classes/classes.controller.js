...
let ClassesController = class ClassesController {
    ...
    async adminSetStatus(id, dto) {
        return this.classesService.adminSetStatus(id, dto.isActive);
    }
    async findById(id) {
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'timeOfDay', required: false, enum: ['morning', 'afternoon', 'evening'] }),
    (0, swagger_1.ApiQuery)({ name: 'trainerId', required: false, description: 'UUID entrenador' }),
...
__decorate([
    ...
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Listado de clases para Admin (puede incluir inactivas)' }),
    __param(0, (0, common_1.Query)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Listado de asistentes de una clase (trainer dueño o admin)' }),
    __param(0, (0, get_user_decorator_1.GetUser)()),
